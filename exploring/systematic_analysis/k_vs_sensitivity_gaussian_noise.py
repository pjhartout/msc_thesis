...
How does the k value influence the sensitivity of MMD to perturbations?
...
def load_gaussian_clustering():
    clustering_eps_2 = normalize(
        pd.read_csv(
            here()
            / "data/systematic/human/fixed_length_kernels/knn_graph/2/gaussian_noise/clustering_histogram/gaussian_noise_mmds.csv"
        )
    )[relevant_cols]
    clustering_eps_2 = clustering_eps_2.assign(
        descriptor="Clustering Histogram", perturb_type="Gaussian Noise", k=2,
    )

    clustering_eps_6 = normalize(
        pd.read_csv(
            here()
            / "data/systematic/human/fixed_length_kernels/knn_graph/6/gaussian_noise/clustering_histogram/gaussian_noise_mmds.csv"
        )
    )[relevant_cols]
    clustering_eps_6 = clustering_eps_6.assign(
        descriptor="Clustering Histogram", perturb_type="Gaussian Noise", k=6,
    )
    ...
    clustering_eps_8 = clustering_eps_8.assign(
        descriptor="Clustering Histogram", perturb_type="Gaussian Noise", k=8,
    )
    df = pd.concat(
        [clustering_eps_2, clustering_eps_6, clustering_eps_8,],
        ignore_index=True,
    )
    return df
...
def load_taper_clustering():
    ...
    clustering_eps_2 = clustering_eps_2.assign(
        descriptor="Clustering Histogram", perturb_type="Taper", k=2,
    )
    ...
    clustering_eps_6 = clustering_eps_6.assign(
        descriptor="Clustering Histogram", perturb_type="Taper", k=6,
    )
    ...
    clustering_eps_8 = clustering_eps_8.assign(
        descriptor="Clustering Histogram", perturb_type="Taper", k=8,
    )
    df = pd.concat(
        [clustering_eps_2, clustering_eps_6, clustering_eps_8,],
        ignore_index=True,
...
def load_twist_clustering():
    ...
    clustering_eps_2 = clustering_eps_2.assign(
        descriptor="Clustering Histogram", perturb_type="Twist", k=2,
    )
    ...
    clustering_eps_6 = clustering_eps_6.assign(
        descriptor="Clustering Histogram", perturb_type="Twist", k=6,
    )
    ...
    clustering_eps_8 = clustering_eps_8.assign(
        descriptor="Clustering Histogram", perturb_type="Twist", k=8,
    )
    df = pd.concat(
        [clustering_eps_2, clustering_eps_6, clustering_eps_8,],
        ignore_index=True,
...
def load_shear_clustering():
    ...
    clustering_eps_2 = clustering_eps_2.assign(
        descriptor="Clustering Histogram", perturb_type="Shear", k=2,
    )
    ...
    clustering_eps_6 = clustering_eps_6.assign(
        descriptor="Clustering Histogram", perturb_type="Shear", k=6,
    )
    ...
    clustering_eps_8 = clustering_eps_8.assign(
        descriptor="Clustering Histogram", perturb_type="Shear", k=8,
    )
    df = pd.concat(
        [clustering_eps_2, clustering_eps_6, clustering_eps_8,],
        ignore_index=True,
...
def load_gaussian_degree():
    ...
    clustering_eps_2 = clustering_eps_2.assign(
        descriptor="Degree Histogram", perturb_type="Gaussian Noise", k=2,
    )
    ...
    clustering_eps_6 = clustering_eps_6.assign(
        descriptor="Degree Histogram", perturb_type="Gaussian Noise", k=6,
    )
    ...
    clustering_eps_8 = clustering_eps_8.assign(
        descriptor="Degree Histogram", perturb_type="Gaussian Noise", k=8,
    )
    df = pd.concat(
        [clustering_eps_2, clustering_eps_6, clustering_eps_8,],
        ignore_index=True,
...
def load_taper_degree():
    ...
    clustering_eps_2 = clustering_eps_2.assign(
        descriptor="Degree Histogram", perturb_type="Taper", k=2,
    )
    ...
    clustering_eps_6 = clustering_eps_6.assign(
        descriptor="Degree Histogram", perturb_type="Taper", k=6,
    )
    ...
    clustering_eps_8 = clustering_eps_8.assign(
        descriptor="Degree Histogram", perturb_type="Taper", k=8,
    )
    df = pd.concat(
        [clustering_eps_2, clustering_eps_6, clustering_eps_8,],
        ignore_index=True,
...
def load_twist_degree():
    ...
    clustering_eps_2 = clustering_eps_2.assign(
        descriptor="Degree Histogram", perturb_type="Twist", k=2,
    )
    ...
    clustering_eps_6 = clustering_eps_6.assign(
        descriptor="Degree Histogram", perturb_type="Twist", k=6,
    )
    ...
    clustering_eps_8 = clustering_eps_8.assign(
        descriptor="Degree Histogram", perturb_type="Twist", k=8,
    )
    df = pd.concat(
        [clustering_eps_2, clustering_eps_6, clustering_eps_8,],
        ignore_index=True,
...
def load_shear_degree():
    ...
    clustering_eps_2 = clustering_eps_2.assign(
        descriptor="Degree Histogram", perturb_type="Shear", k=2,
    )
    ...
    clustering_eps_6 = clustering_eps_6.assign(
        descriptor="Degree Histogram", perturb_type="Shear", k=6,
    )
    ...
    clustering_eps_8 = clustering_eps_8.assign(
        descriptor="Degree Histogram", perturb_type="Shear", k=8,
    )
    df = pd.concat(
        [clustering_eps_2, clustering_eps_6, clustering_eps_8,],
        ignore_index=True,
...
def load_taper_laplacian():
    ...
    clustering_eps_2 = clustering_eps_2.assign(
        descriptor="Laplacian Spectrum Histogram", perturb_type="Taper", k=2,
    )
    ...
    clustering_eps_6 = clustering_eps_6.assign(
        descriptor="Laplacian Spectrum Histogram", perturb_type="Taper", k=6,
    )
    ...
    clustering_eps_8 = clustering_eps_8.assign(
        descriptor="Laplacian Spectrum Histogram", perturb_type="Taper", k=8,
    )
    df = pd.concat(
        [clustering_eps_2, clustering_eps_6, clustering_eps_8,],
        ignore_index=True,
...
def load_twist_laplacian():
    ...
    clustering_eps_2 = clustering_eps_2.assign(
        descriptor="Laplacian Spectrum Histogram", perturb_type="Twist", k=2,
    )
    ...
    clustering_eps_6 = clustering_eps_6.assign(
        descriptor="Laplacian Spectrum Histogram", perturb_type="Twist", k=6,
    )
    ...
    clustering_eps_8 = clustering_eps_8.assign(
        descriptor="Laplacian Spectrum Histogram", perturb_type="Twist", k=8,
    )
    df = pd.concat(
        [clustering_eps_2, clustering_eps_6, clustering_eps_8,],
        ignore_index=True,
...
def load_shear_laplacian():
    ...
    clustering_eps_2 = clustering_eps_2.assign(
        descriptor="Laplacian Spectrum Histogram", perturb_type="Shear", k=2,
    )
    ...
    clustering_eps_6 = clustering_eps_6.assign(
        descriptor="Laplacian Spectrum Histogram", perturb_type="Shear", k=6,
    )
    ...
    clustering_eps_8 = clustering_eps_8.assign(
        descriptor="Laplacian Spectrum Histogram", perturb_type="Shear", k=8,
    )
...
def main():
    ...
    palette = sns.color_palette("mako_r", df["k"].nunique())
