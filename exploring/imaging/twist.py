...
Introduce twisting and save resulting point cloud images.
...
def main(cfg: DictConfig):
    ...
    for idx, i in tqdm(
        ...
        fig.update_layout(scene_camera=camera, title="Twist")

        fig.write_image(
            here() / cfg.imaging.twist_path / f"protein_straight_{idx}.png",
            scale=5,
        )
