...
\subsection{Comparing graph construction techniques from proteins}\label{sec:techniques} To compare which graph
...
\subsection{Lower values of $\varepsilon$ are more
...
\subsection{Quality of MMD using Weisfeiler-Lehman}\label{sec:quality_wl}
...
% TODO kernel acronyms, TDA acronyms
