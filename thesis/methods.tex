...
approach used by \cite{obray2022evaluation}, which we adapt to include the following
steps:
...
heavy atoms directly contributing to the 3D structure of a single monomer, which
...
We introduced \acrshort{mmd} in Section \ref{sec:mmd}, Equation \ref{eq:mmd},
and noted that an important aspect of using \acrshort{mmd} in practice consists
in choosing the right descriptor function and kernel. Here, we list and motivate
all graph extraction techniques, descriptor functions employed, and kernels
...
\cite{obray2022evaluation} have shown, some configurations of \acrshort{mmd} on synthetic
