...
\ref{sec:proteins}. The inspiration behind those two descriptors comes from
elements of the validation pipeline of novel Protein Data Bank structures \citep{read2011new,
  gore2012implementing, gore2017validation}, where atoms too close together are
flagged and unusual dihedral angles are reported. Those unusual dihedral angles
are also called ``Ramachandran outliers'', after the scientist who discovered
those angles \citep{ramachandran1063Stereochemistry}.
\paragraph{Sequence descriptors}
