...
perturbations -- that we will employ to test the various configurations of MMD.
...
curve as well to compare behaviors of different MMD configurations not
...
\cite{o2021evaluation} have shown, some configurations of MMD on synthetic
datasets revealed that an increasing MMD value with increasing perturbation is not
