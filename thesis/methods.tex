...
\gls{mmd} \emph{configuration}.} correlates with the amount of
...
We introduced \gls{mmd} in Section \ref{sec:mmd} (Equation \ref{eq:mmd} and
...
Persistence Fisher kernel \citep{le2018persistence} and the \gls{msk}
