...
% TODO: discuss with Tim MMD baselines.
...
\begin{figure}
  ...
  \caption[Clustering coefficient histogram \gls{mmd} baselines for two
different $\varepsilon$ values.]{Clustering coefficient \gls{mmd} baselines
...
\begin{figure}
  ...
  \caption[Degree distribution histogram \gls{mmd} baselines for two
different $\varepsilon$ values.]{Degree distribution histogram \gls{mmd}
