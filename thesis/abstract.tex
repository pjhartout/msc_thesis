...
use in \acrshort{mmd} to design relevant metrics to evaluate generative models
...
Second, we expand the use of \acrshort{mmd} to encompass previously unused
...
efficiency), we find that there are multiple configurations of MMD that
