...
between any two such vectorized representations using kernels. In the following
...
the most efficient to compute and rich graph descriptor used for biological
