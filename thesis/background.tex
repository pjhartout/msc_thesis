...
Earth mover's distance kernel \citep{o2021evaluation}.
...
kernels. In particular we will examine the most efficient to compute and rich
graph descriptor used for biological data: the Weisfeiler-Lehmann kernel. The
...
\ref{background:tda}, in particular the persistence Fisher kernel introduced by
