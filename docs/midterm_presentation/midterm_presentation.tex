...
\begin{frame}[fragile]{Topological Data Analysis}
  \begin{minipage}{0.3\textwidth}
    \begin{figure}
      \centering
      % \animategraphics[loop,controls,width=0.5\linewidth]{10}{./figures/cech_filtration/something-}{0}{49}%
      \animategraphics[loop,controls,width=0.5\linewidth]{10}{./figures/cech_filtration/something-}{0}{1}%
      % \animategraphics[loop,controls,width=\textwidth]{10}{./figures/cech_filtration/something-}{0}{1}
      \caption{\v{C}ech filtrations captures connected components, cycles and holes
...
\begin{frame}[fragile]{Outlook -- Next steps}
  \begin{minipage}{0.8\textwidth}
    ...
    \begin{itemize}
      ...
      \pause \item Copy problem (using graph edit distance derivative?)
    \end{itemize}
