...

{
  ...
  \begin{minipage}{0.45\textwidth}
    \begin{figure}
      \centering
      \animategraphics[loop,controls,width=\textwidth]{10}{./figures/gaussian_noise/protein_straight_}{0}{20}
  ...
  \begin{minipage}{0.45\textwidth}
    \begin{figure}
      \centering
      \animategraphics[loop,controls,width=\textwidth]{10}{./figures/twist/protein_straight_}{0}{20}
...
\begin{frame}[fragile]{Experiment 2 Preliminaries 2/2 -Topological Data Analysis}
  \begin{minipage}{0.3\textwidth}
    \begin{figure}
      \centering
