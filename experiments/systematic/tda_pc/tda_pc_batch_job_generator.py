...
def main(cfg):
    ...
    slurm_string = "srun --cpus-per-task 10 --mem-per-cpu 70G poetry run python experiments/systematic/tda_pc/tda_pc.py"
    ...
    for perturbation in perturbations:
        job_param = f"{slurm_string}  >> {perturbation}.txt +perturbation={perturbation} \n"
